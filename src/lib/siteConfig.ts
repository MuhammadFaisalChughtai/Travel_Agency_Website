...
export const SITE_CONFIGS: Record<string, SiteConfig> = {
  ...
  "roadtoumrah.co.uk": {
    ...
    currencyCode: "GBP",
    exchangeRate: 1.0,
    allowedTabs: ["umrah", "hajj"], // Only Umrah and Hajj allowed
...
export function formatPrice(basePrice: number | string, config: SiteConfig): string {
  ...
  if (isNaN(numericPrice)) return typeof basePrice === "string" ? basePrice : "N/A";
  ...
  const formattedNumber = convertedPrice % 1 === 0 
