...
const UmrahBanner = dynamic(
  () => import("@/components/home/UmrahBanner").then((mod) => mod.UmrahBanner),
  { ssr: false }
);
          ...
          <section className="py-24 bg-slate-50">
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
              ...
              <div className="flex justify-center mt-12">
                <Link
                  href="/holiday"
                  className="px-8 py-3.5 bg-[#6b4f4f] hover:bg-[#483434] text-[#fff3e4] text-xs font-extrabold uppercase tracking-widest transition-all duration-300 rounded-2xl shadow-md hover:shadow-lg border border-[#eed6c4]/30 flex items-center gap-2"
                >
                  <span>View All Holiday Packages</span>
