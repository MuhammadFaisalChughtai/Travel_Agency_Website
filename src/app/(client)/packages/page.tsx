...
const MOCK_PACKAGES = [
  {
    ...
    price: 1299,
    imageUrl:
      "https://images.unsplash.com/photo-1514282401047-d79a71a590e8?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80",
    type: "HOLIDAY",
  },
  {
    id: "pkg-2",
      ...
      try {
        await prisma.package.create({
          data: {
            ...
            price: pkg.price,
            description:
              "Discover the world's most breathtaking destinations. Handpicked holiday experiences tailored just for you.",
            includedServices: "[]",
        ...
        console.warn(
          `Seeding holiday package ${pkg.id} failed or already exists:`,
          err,
        );
      }
    }
