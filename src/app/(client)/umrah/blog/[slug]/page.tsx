      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="relative h-[55vh] md:h-[65vh] w-full overflow-hidden">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#483434]/90 via-[#483434]/40 to-transparent" />
          ...
          <div className="absolute bottom-0 left-0 right-0 px-6 pb-10 pt-20 max-w-4xl mx-auto w-full">
            <div className="flex items-center gap-2 text-[#eed6c4]/80 text-xs font-bold uppercase tracking-widest mb-4">
              ...
              <span>Journals</span>
              <span>/</span>
              <span className="text-[#eed6c4]">{post.category}</span>
            </div>

            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#6b4f4f] text-white text-[9px] font-black uppercase tracking-wider mb-4">
            ...
            <div className="flex flex-wrap items-center gap-5 text-[#eed6c4]/90 text-xs font-bold uppercase tracking-wider">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-14">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <main className="lg:col-span-8">
              ...
              <Link
                href="/umrah"
                className="inline-flex items-center gap-2 text-[#6b4f4f] text-xs font-extrabold uppercase tracking-widest mb-8 hover:text-[#483434] transition-colors group"
              >
              ...
              <p className="text-lg font-medium text-[#483434] leading-relaxed mb-8 border-l-4 border-[#6b4f4f] pl-5 bg-[#eed6c4]/10 py-4 pr-4 rounded-r-2xl">
                {post.excerpt}
              </p>
              ...
              {/* Divider */}
              <div className="mt-12 pt-8 border-t border-[#eed6c4]/30">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-[#6b4f4f] flex items-center justify-center shrink-0">
              ...
              <div className="mt-10 p-6 rounded-3xl bg-[#483434] text-white flex flex-col sm:flex-row items-start sm:items-center gap-6">
                ...
                <Link
                  href="/umrah"
                  className="shrink-0 px-6 py-3 rounded-full bg-[#6b4f4f] hover:bg-[#eed6c4] hover:text-[#483434] text-white text-xs font-extrabold uppercase tracking-widest transition-all duration-300 whitespace-nowrap"
                >
                  View Packages
                </Link>
              </div>
              ...
              <div className="sticky top-24 space-y-8">
                ...
                <div className="rounded-3xl border border-[#eed6c4]/30 bg-[#eed6c4]/10 p-6 space-y-4">
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex items-center gap-2 text-slate-600">
                      <Calendar className="w-4 h-4 text-[#6b4f4f]" />
                      <span>{post.date}</span>
                    </div>
                    <div className="flex items-center gap-2 text-slate-600">
                      <Clock className="w-4 h-4 text-[#6b4f4f]" />
                ...
                <div className="rounded-3xl bg-[#6b4f4f] text-white p-6 space-y-3">
                  ...
                  <a
                    ...
                    className="inline-block w-full text-center px-5 py-3 rounded-full bg-white text-[#6b4f4f] text-xs font-extrabold uppercase tracking-widest hover:bg-[#eed6c4] transition-colors duration-300 mt-2"
                  >
                    WhatsApp Us
                  </a>
                </div>
