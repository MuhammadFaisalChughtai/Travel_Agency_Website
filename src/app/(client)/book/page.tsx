  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/enquiry", {
        ...
        body: JSON.stringify({ 
          ...formData, 
          type: isFlight ? "Flight Booking" : "Umrah Package",
          packageId: id
        }),
      });
      if (!res.ok) {
      ...
      setStatus("success");
      setFormData({ airport: "", destination: "", date: "", category: "", duration: "", travelers: "", name: "", phone: "", email: "", returnDate: "", travelClass: "", tripType: "Round Trip" });
    } catch (err: any) {
      setStatus("error");
              ...
              {isFlight ? (
                ...
                <>
                  <div className="relative">
                    ...
                    <select name="airport" value={formData.airport} onChange={handleChange} className={selectClass} required>
