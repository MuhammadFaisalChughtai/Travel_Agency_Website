    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-slate-500">
          Add Umrah (3★ / 4★ / 5★), Hajj, and Holiday packages. Use the rich
          text editor to add full package details.
        </p>
      </div>
            ...
            <table className="min-w-full divide-y divide-slate-100">
              ...
              <tbody className="divide-y divide-slate-100 bg-white">
                {packages.map((pkg: any) => {
                  let imgSrc = "";
                  try {
                    imgSrc = JSON.parse(pkg.images)[0];
                  } catch {
                    imgSrc = pkg.images;
                  }
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-3 py-4">
                        <span
                          className={`px-2.5 py-1 rounded-full text-xs font-bold uppercase tracking-wide ${typeBadgeColor[pkg.type] || "bg-slate-100 text-slate-600"}`}
                        >
