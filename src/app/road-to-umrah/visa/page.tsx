  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <Hero
        ...
        badgeIcon={<FileCheck className="w-3.5 h-3.5 text-[#D4AF37]" />}
        title={
          <>
            Hassle-Free{" "}
      ...
      <section className="py-14 bg-[#D4AF37]/10 border-b border-[#D4AF37]/30">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-10">
            <span className="inline-block px-3 py-1 rounded-full bg-[#D4AF37]/20 border border-[#D4AF37]/40 text-[#B8860B] text-[10px] font-extrabold uppercase tracking-widest">
              Simple Process
            </span>
            <h2 className="text-2xl md:text-3xl font-heading font-black text-[#1A472A] tracking-tight mt-3">
              How It Works
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {HOW_IT_WORKS.map((step) => (
              ...
              >
                <div className="w-14 h-14 rounded-2xl bg-[#B8860B] flex items-center justify-center shadow-lg">
                  <span className="text-xl font-heading font-black text-[#D4AF37]">
                    {step.step}
                  </span>
                </div>
                <div>
                  <h3 className="text-sm font-heading font-black text-[#1A472A] mb-1.5">
                    {step.title}
                  </h3>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center space-y-3 mb-12">
            ...
            <h2 className="text-2xl md:text-3xl font-heading font-black text-[#1A472A] tracking-tight">
              ...
              return (
                <Link
                  ...
                  className={`bg-white rounded-3xl overflow-hidden border transition-all duration-300 flex flex-col group hover:-translate-y-1 relative block ${
                    visa.isPopular
                      ? "border-[#B8860B]/40 shadow-[0_15px_45px_rgba(107,79,79,0.12)]"
                      : "border-[#D4AF37]/25 shadow-[0_10px_35px_rgba(72,52,52,0.03)] hover:shadow-[0_15px_45px_rgba(72,52,52,0.08)] hover:border-[#B8860B]/30"
                  }`}
                >
                  {visa.isPopular && (
                    <div className="absolute top-4 right-4 z-20">
                      <span className="px-3 py-1.5 rounded-full bg-[#B8860B] text-white text-[9px] font-black uppercase tracking-wider shadow-sm">
                        Most Popular
                      </span>
                    </div>
                  )}
                  ...
                  <div className="relative h-44 w-full overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#1A472A]/60 to-transparent" />
                  ...
                  <div className="p-6 flex flex-col flex-grow space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {[
                        ...
                        >
                          ...
                          <p className="text-[10px] font-black text-[#1A472A] mt-0.5">
                            {stat.value}
                          </p>
                        </div>
                      ))}
                    ...
                    <div className="border-t border-[#D4AF37]/30 pt-4 flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-heading font-black text-[#1A472A]">
                          {visa.price}
                        </p>
                      ...
                      <span className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-full bg-[#B8860B] hover:bg-[#1A472A] text-white text-[10px] font-extrabold uppercase tracking-widest transition-all duration-300 shadow-md hover:shadow-lg group/btn">
                        Details
      ...
      <section className="py-10 bg-[#D4AF37]/10 border-t border-[#D4AF37]/30">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          <div className="flex items-start gap-4 p-6 rounded-3xl border border-[#B8860B]/20 bg-white shadow-sm">
            <AlertCircle className="w-5 h-5 text-[#B8860B] shrink-0 mt-0.5" />
            <div>
              <h3 className="text-sm font-heading font-black text-[#1A472A] mb-2">
            ...
            <div className="relative z-10 p-10 md:p-14 flex flex-col md:flex-row items-start md:items-center gap-8">
              ...
              <div className="shrink-0 flex flex-col gap-3">
                <a
                  ...
                  className="px-8 py-4 rounded-full bg-[#B8860B] hover:bg-[#D4AF37] hover:text-[#1A472A] text-white text-[10px] font-extrabold uppercase tracking-widest transition-all duration-300 border border-[#D4AF37]/20 hover:border-[#D4AF37] text-center"
                >
                  WhatsApp Us
                </a>
                <Link
