      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="relative h-[55vh] md:h-[65vh] w-full overflow-hidden">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#1A472A]/90 via-[#1A472A]/40 to-transparent" />
          ...
          <div className="absolute bottom-0 left-0 right-0 px-6 pb-10 pt-20 max-w-4xl mx-auto w-full">
            ...
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#B8860B] text-white text-[9px] font-black uppercase tracking-wider mb-4">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-14">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <main className="lg:col-span-8">
              ...
              <Link
                href="/umrah"
                className="inline-flex items-center gap-2 text-[#B8860B] text-xs font-extrabold uppercase tracking-widest mb-8 hover:text-[#1A472A] transition-colors group"
              >
              ...
              <p className="text-lg font-medium text-[#1A472A] leading-relaxed mb-8 border-l-4 border-[#B8860B] pl-5 bg-[#D4AF37]/10 py-4 pr-4 rounded-r-2xl">
                {post.excerpt}
              </p>
              ...
              <div className="mt-12 pt-8 border-t border-[#D4AF37]/30">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs font-black text-[#1A472A] uppercase tracking-widest">
              ...
              {/* CTA */}
              <div className="mt-10 p-6 rounded-3xl bg-[#1A472A] text-white flex flex-col sm:flex-row items-start sm:items-center gap-6">
                ...
                <Link
                  href="/umrah"
                  className="shrink-0 px-6 py-3 rounded-full bg-[#B8860B] hover:bg-[#D4AF37] hover:text-[#1A472A] text-white text-xs font-extrabold uppercase tracking-widest transition-all duration-300 whitespace-nowrap"
                >
                  View Packages
                </Link>
              </div>
            ...
            <aside className="lg:col-span-4 space-y-8">
              <div className="sticky top-24 space-y-8">
                ...
                <div className="rounded-3xl border border-[#D4AF37]/30 bg-[#D4AF37]/10 p-6 space-y-4">
                  <h3 className="text-sm font-heading font-black text-[#1A472A] uppercase tracking-widest">
                    Article Details
                  </h3>
                ...
                {/* Related Articles */}
                <div>
                  <h3 className="text-sm font-heading font-black text-[#1A472A] uppercase tracking-widest mb-5">
                    Related Articles
                  </h3>
                  <div className="space-y-4">
                    {relatedPosts.map((related) => (
                      <Link
                        ...
                        className="group flex gap-3 items-start rounded-2xl p-3 border border-[#D4AF37]/20 hover:border-[#B8860B]/40 hover:bg-[#D4AF37]/10 transition-all duration-300"
                      >
                ...
                {/* Quick Contact */}
                <div className="rounded-3xl bg-[#B8860B] text-white p-6 space-y-3">
                  ...
                  <a
                    ...
                    className="inline-block w-full text-center px-5 py-3 rounded-full bg-white text-[#B8860B] text-xs font-extrabold uppercase tracking-widest hover:bg-[#D4AF37] transition-colors duration-300 mt-2"
                  >
                    WhatsApp Us
                  </a>
                </div>
