  ...
  return (
    <div className="bg-[#f5f0eb] min-h-screen pb-24">
      <Hero
        ...
        badgeText="Legal"
        title={<>Privacy <span className="text-[#DFDE7D] font-black drop-shadow-[0_2px_10px_rgba(238,214,196,0.2)]">Policy</span></>}
        description="How we protect your data and privacy."
        showTrustpilot={false}
      />

      <div className="mx-auto max-w-4xl px-6 lg:px-8 mt-16">
        <div className="bg-[#fff8f0] rounded-3xl shadow-xl shadow-[#454E63]/5 border border-[#DFDE7D]/60 p-8 md:p-12">
          <article className="prose max-w-none">
            <h2 className="font-heading text-2xl text-[#2a1a1a] font-black mb-4 tracking-wide uppercase">1. Introduction</h2>
            <p className="text-[#009F75] font-medium leading-relaxed mb-6">
            ...
            <ul className="list-disc pl-6 text-[#009F75] font-medium leading-relaxed mb-6 space-y-2">
