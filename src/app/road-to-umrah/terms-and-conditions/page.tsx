      ...
      <div className="mx-auto max-w-4xl px-6 lg:px-8 mt-16">
        <div className="bg-white rounded-3xl shadow-2xl shadow-[#064e3b]/10 border border-[#d4af37]/30 p-8 md:p-12">
          <article className="prose max-w-none">
            <h2 className="font-heading text-2xl text-[#064e3b] font-black mb-4 tracking-wide uppercase">1. Booking Contract</h2>
            ...
            <h2 className="font-heading text-2xl text-[#064e3b] font-black mb-4 mt-8 tracking-wide uppercase">2. Financial Protection (ATOL)</h2>
            <p className="text-slate-600 font-medium leading-relaxed mb-6">
            ...
            <h2 className="font-heading text-2xl text-[#064e3b] font-black mb-4 mt-8 tracking-wide uppercase">3. Prices and Payment</h2>
            <p className="text-slate-600 font-medium leading-relaxed mb-6">
            ...
            <h2 className="font-heading text-2xl text-[#064e3b] font-black mb-4 mt-8 tracking-wide uppercase">4. Cancellations and Changes by You</h2>
            <p className="text-slate-600 font-medium leading-relaxed mb-6">
            ...
            <h2 className="font-heading text-2xl text-[#064e3b] font-black mb-4 mt-8 tracking-wide uppercase">5. Passports, Visas, and Health</h2>
            <p className="text-slate-600 font-medium leading-relaxed mb-6">
              It is your responsibility to check and fulfill the passport, visa, health and immigration requirements applicable to your itinerary. We can only provide general information about this. You must check requirements for your own specific circumstances with the relevant Embassies and/or Consulates and your own doctor as applicable.
            </p>

            <h2 className="font-heading text-2xl text-[#064e3b] font-black mb-4 mt-8 tracking-wide uppercase">6. Travel Insurance</h2>
            <p className="text-slate-600 font-medium leading-relaxed mb-6">
