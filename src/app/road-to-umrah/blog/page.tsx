                ...
                {categoryBlogs.map((post: any) => (
                  ...
                  >
                    ...
                    <div className="p-6 flex flex-col flex-grow space-y-4">
                      ...
                      <h3 className="text-lg font-heading font-black text-slate-900 leading-snug group-hover:text-[#B8860B] transition-colors duration-300">
                        {post.title}
                      </h3>
                      ...
                      <div className="border-t border-slate-100 pt-4">
                        <Link
                          href={`/blog/${post.slug}`}
                          className="inline-flex items-center gap-1.5 text-xs font-extrabold text-[#B8860B] group-hover:text-slate-900 transition-colors duration-300 uppercase tracking-widest"
                        >
