  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <Hero
        ...
        badgeIcon={<Car className="w-3.5 h-3.5 text-[#DFDE7D]" />}
        title={
          <>
            VIP{" "}
      ...
      {/* ─── How It Works ─── */}
      <section className="py-14 bg-[#DFDE7D]/10 border-b border-[#DFDE7D]/30">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl md:text-3xl font-heading font-black text-[#454E63] tracking-tight mt-3">
              How It Works
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {HOW_IT_WORKS.map((step) => (
              ...
              >
                <div className="w-14 h-14 rounded-2xl bg-[#009F75] flex items-center justify-center shadow-lg">
                  <span className="text-xl font-heading font-black text-[#DFDE7D]">
                    {step.step}
                  </span>
                </div>
                <div>
                  <h3 className="text-sm font-heading font-black text-[#454E63] mb-1.5">
                    {step.title}
                  </h3>
              ...
              return (
                <Link
                  ...
                  className={`bg-white rounded-3xl overflow-hidden border transition-all duration-300 flex flex-col group ${hasSlug ? 'hover:-translate-y-1 cursor-pointer' : 'opacity-75 cursor-default'} relative block ${
                    vehicle.isPopular
                      ? "border-[#009F75]/40 shadow-[0_15px_45px_rgba(107,79,79,0.12)]"
                      : "border-[#DFDE7D]/25 shadow-[0_10px_35px_rgba(72,52,52,0.03)] hover:shadow-[0_15px_45px_rgba(72,52,52,0.08)] hover:border-[#009F75]/30"
                  }`}
                >
                  {vehicle.isPopular && (
                    <div className="absolute top-4 right-4 z-20">
                      <span className="px-3 py-1.5 rounded-full bg-[#009F75] text-white text-[9px] font-black uppercase tracking-wider shadow-sm">
                        Most Popular
                      </span>
                    </div>
                  )}
                  ...
                  <div className="relative h-44 w-full overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#454E63]/60 to-transparent" />
                    <div className="absolute bottom-4 left-5 flex items-center gap-2">
                      <div className="bg-white/10 p-2 rounded-full backdrop-blur-sm">
                        <Car className="w-5 h-5 text-[#DFDE7D]" />
                      </div>
                      <div>
                        <p className="text-white font-heading font-black text-sm leading-none">
                          {vehicle.vehicleType}
                        </p>
                        <p className="text-[#DFDE7D] text-[10px] font-bold mt-0.5">
                          {vehicle.type}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="p-6 flex flex-col flex-grow space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {[
                        ...
                        <div
                          key={stat.label}
                          className="bg-[#DFDE7D]/10 rounded-xl p-2.5 text-center"
                        >
                          <div className="flex justify-center mb-1 text-[#009F75]">
                            {stat.icon}
                          </div>
                          <p className="text-[9px] text-slate-400 font-bold uppercase tracking-wider">
                            {stat.label}
                          </p>
                          <p className="text-[10px] font-black text-[#454E63] mt-0.5 truncate">
                            {stat.value}
                          </p>
                        </div>
                      ))}
                    ...
                    <ul className="space-y-2 flex-grow">
                      {parsedFeatures.slice(0, 4).map((feature: string) => (
                        ...
                        >
                          <ShieldCheck className="w-3.5 h-3.5 text-[#009F75] shrink-0" />
                          {feature}
                        </li>
                      ))}
                    </ul>
                    ...
                    {/* Price + CTA */}
                    <div className="border-t border-[#DFDE7D]/30 pt-4 flex items-center justify-between">
                      <div>
                        <p className="text-[9px] text-slate-400 uppercase tracking-widest font-bold">
                          One-Way from
                        </p>
                        <p className="text-2xl font-heading font-black text-[#454E63]">
                          {vehicle.price}
                        </p>
                      ...
                      <span className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-full bg-[#009F75] hover:bg-[#454E63] text-white text-[10px] font-extrabold uppercase tracking-widest transition-all duration-300 shadow-md hover:shadow-lg group/btn">
                        Details
      ...
      {/* ─── Important Note ─── */}
      <section className="py-10 bg-[#DFDE7D]/10 border-t border-[#DFDE7D]/30">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          <div className="flex items-start gap-4 p-6 rounded-3xl border border-[#009F75]/20 bg-white shadow-sm">
            <AlertCircle className="w-5 h-5 text-[#009F75] shrink-0 mt-0.5" />
            <div>
              <h3 className="text-sm font-heading font-black text-[#454E63] mb-2">
      ...
      {/* ─── CTA Banner ─── */}
      <section className="py-16 bg-white border-t border-[#DFDE7D]/30">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="rounded-3xl bg-[#382626] overflow-hidden relative">
            ...
            <div className="relative z-10 p-10 md:p-14 flex flex-col md:flex-row items-start md:items-center gap-8">
              <div className="flex-grow space-y-3">
                <span className="inline-block px-3 py-1 rounded-full bg-[#DFDE7D]/15 border border-[#DFDE7D]/30 text-[#DFDE7D] text-[9px] font-extrabold uppercase tracking-[0.2em]">
                  Custom Transfers
                </span>
                ...
                <div className="flex flex-wrap gap-4 pt-2">
                  {["Makkah", "Madinah", "Dubai", "London"].map((c) => (
                    <span
                      key={c}
                      className="flex items-center gap-1.5 text-[#DFDE7D]/80 text-[10px] font-bold"
                    >
              ...
              <div className="shrink-0 flex flex-col gap-3">
                <a
                  ...
                  className="px-8 py-4 rounded-full bg-[#009F75] hover:bg-[#DFDE7D] hover:text-[#454E63] text-white text-[10px] font-extrabold uppercase tracking-widest transition-all duration-300 border border-[#DFDE7D]/20 hover:border-[#DFDE7D] text-center"
                >
                  WhatsApp Us
                </a>
                <Link
                  href="/contact"
                  className="px-8 py-4 rounded-full border border-[#DFDE7D]/40 text-[#DFDE7D] hover:bg-[#DFDE7D]/10 text-[10px] font-extrabold uppercase tracking-widest transition-all duration-300 text-center flex items-center justify-center gap-1.5"
                >
