      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 mt-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-10">
            ...
            <p className="text-[#c63c51] leading-relaxed text-lg">
            ...
            <div className="space-y-8">
              <div className="flex gap-5">
                <div className="w-14 h-14 bg-[#8c3061] rounded-2xl flex items-center justify-center flex-shrink-0 shadow-sm border border-[#8c3061]">
                  <MapPin className="w-6 h-6 text-[#522258]" />
                </div>
                <div>
                  <h3 className="font-black text-[#2a1a1a] text-lg mb-1 tracking-wide font-heading uppercase">
                    Office Location
                  </h3>
                  <p className="text-[#c63c51] font-medium leading-relaxed">
                    <a 
                      target="_blank" 
              ...
              <div className="flex gap-5">
                <div className="w-14 h-14 bg-[#8c3061] rounded-2xl flex items-center justify-center flex-shrink-0 shadow-sm border border-[#8c3061]">
                  <Phone className="w-6 h-6 text-[#522258]" />
                </div>
                <div>
                  <h3 className="font-black text-[#2a1a1a] text-lg mb-1 tracking-wide font-heading uppercase">
                    Phone
                  ...
                  <p className="text-[#c63c51] font-medium leading-relaxed">
                    <a
                      ...
                      className="hover:text-[#522258] transition-colors"
                    >
                      +44 1215 291630
                    </a>
                    <br />
              ...
              <div className="flex gap-5">
                <div className="w-14 h-14 bg-[#8c3061] rounded-2xl flex items-center justify-center flex-shrink-0 shadow-sm border border-[#8c3061]">
                  <Mail className="w-6 h-6 text-[#522258]" />
                </div>
                <div>
                  <h3 className="font-black text-[#2a1a1a] text-lg mb-1 tracking-wide font-heading uppercase">
                    Email
              ...
              <div className="flex gap-5">
                <div className="w-14 h-14 bg-[#8c3061] rounded-2xl flex items-center justify-center flex-shrink-0 shadow-sm border border-[#8c3061]">
                  <Clock className="w-6 h-6 text-[#522258]" />
                </div>
                <div>
                  <h3 className="font-black text-[#2a1a1a] text-lg mb-1 tracking-wide font-heading uppercase">
                    Working Hours
            ...
            <div className="bg-[#c63c51] rounded-3xl p-8 mt-12 flex items-start gap-6 text-white shadow-xl">
              <ShieldCheck className="w-10 h-10 text-[#8c3061] flex-shrink-0" />
              <div>
                <h4 className="font-black text-xl font-heading tracking-wide">ATOL Protected</h4>
                <p className="text-sm text-[#8c3061]/80 mt-2 leading-relaxed">
