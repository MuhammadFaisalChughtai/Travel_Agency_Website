  ...
  return (
    <div className="bg-[#f5f0eb] min-h-screen pb-24">
      <Hero
        ...
        title={<>About <span className="text-[#DFDE7D] font-black drop-shadow-[0_2px_10px_rgba(238,214,196,0.2)]">Terrific Travel</span></>}
        description="Your trusted partner in creating unforgettable journeys and sacred pilgrimages across the globe."
        showTrustpilot={true}
      />

      <div className="mx-auto max-w-7xl px-6 lg:px-8 mt-16">
        <div className="bg-[#fff8f0] rounded-3xl shadow-xl shadow-[#454E63]/5 border border-[#DFDE7D]/60 p-8 md:p-12 mb-16">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-black text-[#2a1a1a] mb-6 font-heading">Our Mission</h2>
            <p className="text-[#009F75] font-medium text-lg leading-relaxed mb-8">
            ...
            <p className="text-[#009F75] font-medium text-lg leading-relaxed">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-[#009F75] font-medium mt-4 max-w-2xl mx-auto">We combine years of industry expertise with a passion for excellence to deliver the best travel experiences.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-[#fff8f0] p-8 rounded-3xl border border-[#DFDE7D]/60 shadow-xl shadow-[#454E63]/5 text-center hover:-translate-y-1 transition-transform duration-300">
            <div className="w-16 h-16 bg-[#DFDE7D] border border-[#DFDE7D] rounded-2xl flex items-center justify-center mx-auto mb-6">
              <ShieldCheck className="w-8 h-8 text-[#454E63]" />
            </div>
            <h3 className="font-black text-[#2a1a1a] text-xl mb-3 font-heading uppercase tracking-wide">ATOL Protected</h3>
            <p className="text-[#009F75] font-medium text-sm leading-relaxed">Your financial security is our priority. Every flight-inclusive holiday is 100% ATOL protected.</p>
          </div>

          <div className="bg-[#fff8f0] p-8 rounded-3xl border border-[#DFDE7D]/60 shadow-xl shadow-[#454E63]/5 text-center hover:-translate-y-1 transition-transform duration-300">
            <div className="w-16 h-16 bg-[#DFDE7D] border border-[#DFDE7D] rounded-2xl flex items-center justify-center mx-auto mb-6">
              <HeartHandshake className="w-8 h-8 text-[#454E63]" />
            </div>
            <h3 className="font-black text-[#2a1a1a] text-xl mb-3 font-heading uppercase tracking-wide">Expert Guidance</h3>
            <p className="text-[#009F75] font-medium text-sm leading-relaxed">Our seasoned travel consultants provide personalized advice tailored specifically to your needs.</p>
          </div>

          <div className="bg-[#fff8f0] p-8 rounded-3xl border border-[#DFDE7D]/60 shadow-xl shadow-[#454E63]/5 text-center hover:-translate-y-1 transition-transform duration-300">
            <div className="w-16 h-16 bg-[#DFDE7D] border border-[#DFDE7D] rounded-2xl flex items-center justify-center mx-auto mb-6">
              <Globe className="w-8 h-8 text-[#454E63]" />
            </div>
            <h3 className="font-black text-[#2a1a1a] text-xl mb-3 font-heading uppercase tracking-wide">Global Network</h3>
            <p className="text-[#009F75] font-medium text-sm leading-relaxed">We partner with the world's leading airlines and hotels to offer you exclusive rates and upgrades.</p>
          </div>

          <div className="bg-[#fff8f0] p-8 rounded-3xl border border-[#DFDE7D]/60 shadow-xl shadow-[#454E63]/5 text-center hover:-translate-y-1 transition-transform duration-300">
            <div className="w-16 h-16 bg-[#DFDE7D] border border-[#DFDE7D] rounded-2xl flex items-center justify-center mx-auto mb-6">
              <Award className="w-8 h-8 text-[#454E63]" />
            </div>
            <h3 className="font-black text-[#2a1a1a] text-xl mb-3 font-heading uppercase tracking-wide">Premium Quality</h3>
            <p className="text-[#009F75] font-medium text-sm leading-relaxed">We never compromise on quality. Expect 5-star service from the moment you book until you return.</p>
          </div>
        </div>
      </div>
    </div>
