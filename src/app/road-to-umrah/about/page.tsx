  ...
  return (
    <div className="bg-[#f5f0eb] min-h-screen pb-24">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 mt-16">
        <div className="bg-[#fff8f0] rounded-3xl shadow-xl shadow-[#064e3b]/5 border border-[#d4af37]/60 p-8 md:p-12 mb-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-[#064e3b] font-medium mt-4 max-w-2xl mx-auto">We combine years of industry expertise with a passion for excellence to deliver the best travel experiences.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-[#fff8f0] p-8 rounded-3xl border border-[#d4af37]/60 shadow-xl shadow-[#064e3b]/5 text-center hover:-translate-y-1 transition-transform duration-300">
            ...
            <p className="text-[#064e3b] font-medium text-sm leading-relaxed">Your financial security is our priority. Every flight-inclusive holiday is 100% ATOL protected.</p>
          </div>
          ...
          <div className="bg-[#fff8f0] p-8 rounded-3xl border border-[#d4af37]/60 shadow-xl shadow-[#064e3b]/5 text-center hover:-translate-y-1 transition-transform duration-300">
            ...
            <p className="text-[#064e3b] font-medium text-sm leading-relaxed">Our seasoned travel consultants provide personalized advice tailored specifically to your needs.</p>
          </div>
          ...
          <div className="bg-[#fff8f0] p-8 rounded-3xl border border-[#d4af37]/60 shadow-xl shadow-[#064e3b]/5 text-center hover:-translate-y-1 transition-transform duration-300">
            ...
            <p className="text-[#064e3b] font-medium text-sm leading-relaxed">We partner with the world's leading airlines and hotels to offer you exclusive rates and upgrades.</p>
          </div>
          ...
          <div className="bg-[#fff8f0] p-8 rounded-3xl border border-[#d4af37]/60 shadow-xl shadow-[#064e3b]/5 text-center hover:-translate-y-1 transition-transform duration-300">
            ...
            <p className="text-[#064e3b] font-medium text-sm leading-relaxed">We never compromise on quality. Expect 5-star service from the moment you book until you return.</p>
          </div>
        </div>
      </div>
    </div>
