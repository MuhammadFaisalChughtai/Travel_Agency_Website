...
export default async function UniversalViewPage({ params }: ViewPageProps) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-[#0d47a1]">
      ...
      <Hero
        ...
        customRatingBadge={
          type !== "blog" ? (
            <div className="flex flex-wrap items-center gap-4 text-xs md:text-sm text-slate-300 font-light pt-1">
              {item.destination && (
                <span className="flex items-center gap-1">
                  <MapPin className="w-4 h-4 text-[#453d25]" />{" "}
                  {item.destination}
                </span>
              )}
              {item.duration && (
                <span className="flex items-center gap-1">
                  <Clock className="w-4 h-4 text-[#453d25]" /> {item.duration}
                </span>
              )}
              {item.stars && (
                <div className="flex gap-0.5 text-[#453d25]">
                  {[...Array(item.stars)].map((_, i) => (
                    <Star
                      key={i}
                      className="w-3.5 h-3.5 fill-[#453d25] stroke-none"
                    />
                  ))}
                </div>
              )}
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs text-[#453d25] font-bold uppercase tracking-widest pt-1">
      ...
      {/* ─── Breadcrumb ─── */}
      <div className="bg-[#F9FAFB] border-b border-[#453d25]/30 py-3.5">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 flex items-center gap-2 text-xs font-bold text-[#e91e63] uppercase tracking-wider">
          ...
          <main className="lg:col-span-8 space-y-12">
            ...
            {type === "blog" && (
              <article className="space-y-8">
                <Link
                  href="/umrah"
                  className="inline-flex items-center gap-2 text-[#e91e63] text-[10px] font-extrabold uppercase tracking-widest hover:text-[#0d47a1] transition-colors group"
                >
                  <ArrowLeft className="w-3.5 h-3.5 group-hover:-translate-x-1 transition-transform duration-300" />
                  Back to Umrah Journals
                </Link>

                <p className="text-base md:text-lg font-medium text-[#0d47a1] leading-relaxed border-l-4 border-[#e91e63] pl-5 bg-[#453d25]/15 py-4.5 pr-4 rounded-r-3xl">
                  {item.excerpt}
                </p>
                ...
                <style>{`
                  ...
                  .prose-article h3 { font-size: 1.25rem; font-weight: 800; color: #e91e63; }
                  .prose-article h4 { font-size: 1.1rem; font-weight: 800; color: #e91e63; }
                  ...
                  .prose-article strong { color: #0d47a1; font-weight: 700; }
                  .prose-article em { color: #e91e63; font-style: italic; }
                  ...
                  .prose-article a:hover { color: #0d47a1; }
            ...
            {type === "package" && (
              <div className="space-y-8">
                ...
                <section className="bg-white rounded-3xl p-8 border border-[#453d25]/30 shadow-[0_10px_35px_rgba(72,52,52,0.03)]">
                  <h2 className="text-xl font-heading font-black text-[#0d47a1] mb-6 flex items-center gap-2">
                    <Award className="w-5 h-5 text-[#e91e63]" /> What's Included
                  </h2>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                      {
                        icon: (
                          <PlaneTakeoff className="w-7 h-7 text-[#e91e63]" />
                        ),
                        label: "Flights",
                        sub: "Return flights from UK",
                      },
                      {
                        icon: <Building2 className="w-7 h-7 text-[#e91e63]" />,
                        label: "Hotel",
                        sub: `${item.stars || 3}-Star accommodation`,
                      },
                      {
                        icon: <Car className="w-7 h-7 text-[#e91e63]" />,
                        label: "Transport",
                        sub: item.type === "HOLIDAY" ? "Transfers Included" : "Makkah ↔ Madinah",
                      },
                      {
                        icon: <FileCheck className="w-7 h-7 text-[#e91e63]" />,
                        label: "Visa",
                      ...
                      <div
                        key={label}
                        className="flex flex-col items-center text-center gap-3 bg-[#F9FAFB] rounded-2xl p-5 border border-[#453d25]/40 hover:border-[#e91e63]/30 hover:shadow-md transition-all duration-300 group"
                      >
                        <div className="w-14 h-14 rounded-2xl bg-white border border-[#453d25]/50 flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform duration-300">
                          {icon}
                        </div>
                        <div>
                          <p className="font-heading font-black text-[#0d47a1] text-sm">
                            {label}
                          </p>
                ...
                <section className="bg-white rounded-3xl p-8 border border-[#453d25]/30 shadow-[0_10px_35px_rgba(72,52,52,0.03)]">
                  <h2 className="text-xl font-heading font-black text-[#0d47a1] mb-6 flex items-center gap-2">
                    <MapPin className="w-5 h-5 text-[#e91e63]" /> Your Journey
                  </h2>
                  <div className="relative">
                    {/* Connecting line */}
                    <div className="absolute top-8 left-8 right-8 h-[2px] bg-gradient-to-r from-[#453d25] via-[#e91e63]/30 to-[#453d25] hidden md:block" />
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 relative z-10">
                      {[
                        ...
                        >
                          <div className="w-16 h-16 rounded-full bg-[#e91e63] flex items-center justify-center text-white shadow-lg shadow-[#e91e63]/20 relative">
                            {icon}
                            <span className="absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full bg-[#453d25] text-[#0d47a1] text-[9px] font-black flex items-center justify-center border border-white">
                              {step}
                            </span>
                          </div>
                          <p className="font-heading font-black text-[#0d47a1] text-sm mt-1">
                            {label}
                          </p>
                ...
                {item.description && item.description.trim().length > 0 && (
                  <section className="bg-white rounded-3xl p-8 border border-[#453d25]/30 shadow-[0_10px_35px_rgba(72,52,52,0.03)]">
                    <h2 className="text-xl font-heading font-black text-[#0d47a1] mb-5 flex items-center gap-2">
                      <Sparkles className="w-5 h-5 text-[#e91e63]" /> Package
                      Details
                    </h2>
                    <div
                      className="prose-article"
                    ...
                    <style>{`
                      ...
                      .prose-article h2 { font-size: 1.35rem; border-bottom: 2px solid #453d25; padding-bottom: 0.4rem; }
                      .prose-article h3 { font-size: 1.15rem; color: #e91e63; }
                      ...
                      .prose-article strong { color: #0d47a1; font-weight: 700; }
                      .prose-article em { color: #e91e63; font-style: italic; }
                      .prose-article blockquote { border-left: 4px solid #e91e63; background: #453d2515; padding: 1rem 1.2rem; border-radius: 0 0.5rem 0.5rem 0; margin: 1.5rem 0; font-style: italic; color: #0d47a1; }
                      ...
                      .prose-article a { color: #e91e63; text-decoration: underline; font-weight: 600; }
                      .prose-article a:hover { color: #0d47a1; }
                      .prose-article table { width: 100%; border-collapse: collapse; margin: 1.5rem 0; font-size: 0.9rem; }
                      .prose-article th { background: #453d25; color: #0d47a1; font-weight: 700; padding: 0.6rem 1rem; text-align: left; }
                      .prose-article td { padding: 0.6rem 1rem; border-bottom: 1px solid #453d2520; color: #4b5563; }
                ...
                {/* ── Guarantee note ── */}
                <section className="bg-[#453d25]/15 border border-[#453d25]/40 rounded-3xl p-6 flex items-start gap-4">
                  <AlertCircle className="w-6 h-6 text-[#e91e63] shrink-0 mt-0.5" />
                  <div>
                    <h3 className="font-heading font-black text-[#0d47a1] text-base mb-1.5">
            ...
            {type === "flight" && (
              <div className="space-y-10">
                ...
                <section className="bg-white rounded-3xl p-8 border border-[#453d25]/30 shadow-[0_10px_35px_rgba(72,52,52,0.03)] space-y-6">
                  <h2 className="text-xl font-heading font-black text-[#0d47a1] flex items-center gap-2">
                    <PlaneTakeoff className="w-5 h-5 text-[#e91e63]" /> Outbound
                    Flight Path
                  </h2>

                  {/* Visual Route */}
                  <div className="flex flex-col md:flex-row items-center justify-between gap-6 p-6 bg-[#F9FAFB]/50 rounded-2xl border border-[#453d25]/40">
                    {/* Departure */}
                    <div className="text-center md:text-left space-y-1 min-w-[120px]">
                      <p className="text-[9px] text-slate-400 font-bold uppercase tracking-wider">
                        Departure Airport
                      </p>
                      <p className="text-sm font-heading font-black text-[#0d47a1] leading-tight">
                        {item.departure}
                      </p>
                      <span className="inline-block px-2.5 py-0.5 bg-[#e91e63] text-white text-[10px] font-black rounded-lg uppercase">
                        {item.departureCode}
                      </span>
                    </div>
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center min-w-[160px] w-full px-4">
                      <span className="text-[10px] font-bold text-[#e91e63] uppercase tracking-widest mb-1">
                        {item.duration}
                      </span>
                      ...
                      {item.isTransit ? (
                        <div className="w-full flex items-center justify-between relative px-2">
                          {/* Connection line */}
                          <div className="absolute left-0 right-0 top-1/2 -translate-y-1/2 h-[2px] bg-[#453d25] z-0" />
                          {/* Left dot */}
                          <div className="w-3 h-3 rounded-full border-2 border-[#e91e63] bg-white z-10" />

                          {/* Transit node */}
                          <div className="flex flex-col items-center bg-white border border-[#453d25] px-2 py-0.5 rounded-full z-10 shadow-sm">
                        ...
                        <div className="w-full flex items-center justify-between relative px-2">
                          ...
                          {/* Direct marker */}
                          <div className="bg-[#e91e63] text-white text-[8px] font-bold px-2 py-0.5 rounded-full z-10 uppercase tracking-widest">
                            Direct
                          </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-4 border-t border-slate-100">
                    <div>
                      ...
                      <p className="text-xs font-black text-[#0d47a1] mt-1">
                ...
                {item.isReturn && (
                  <section className="bg-white rounded-3xl p-8 border border-[#453d25]/30 shadow-[0_10px_35px_rgba(72,52,52,0.03)] space-y-6">
                    <h2 className="text-xl font-heading font-black text-[#0d47a1] flex items-center gap-2">
                      <PlaneLanding className="w-5 h-5 text-[#e91e63]" /> Return
                      Flight Path
                    </h2>
                ...
                <section className="bg-[#453d25]/15 border border-[#453d25]/40 rounded-3xl p-6.5 flex items-start gap-4">
                  <AlertCircle className="w-6 h-6 text-[#e91e63] shrink-0 mt-0.5" />
                  <div>
                    <h3 className="font-heading font-black text-[#0d47a1] text-base mb-1.5">
                      Airport Information
            ...
            {type === "visa" && (
              <div className="space-y-10">
                {/* Main Specs Section */}
                <section className="bg-white rounded-3xl p-8 border border-[#453d25]/30 shadow-[0_10px_35px_rgba(72,52,52,0.03)] space-y-8">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-[#453d25]/20 pb-6">
                    <div>
                      <h2 className="text-2xl font-heading font-black text-[#0d47a1] flex items-center gap-2">
                        <FileCheck className="w-6 h-6 text-[#e91e63]" /> Visa Overview
                      </h2>
                      <p className="text-xs text-slate-500 font-medium mt-1">Official Immigration &amp; Travel Permits</p>
                    </div>
                    <div className="bg-[#F9FAFB] px-4 py-2 rounded-xl border border-[#453d25]/40 flex items-center gap-2">
                      <ShieldCheck className="w-4 h-4 text-[#e91e63]" />
                      <span className="text-xs font-black text-[#0d47a1] tracking-wider uppercase">Verified Agent</span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                      ...
                      <div
                        key={i}
                        className="bg-slate-50 rounded-2xl p-5 border border-slate-100 text-center hover:bg-[#F9FAFB]/50 hover:border-[#453d25]/40 transition-colors duration-300 flex flex-col items-center group"
                      >
                        <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-[#e91e63] shadow-sm mb-3 group-hover:scale-110 transition-transform">
                          {spec.icon}
                        </div>
                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider mb-1">
                          {spec.label}
                        </p>
                        <p className="text-sm font-black text-[#0d47a1] flex items-center justify-center gap-1.5">
                ...
                <section className="bg-white rounded-3xl p-8 border border-[#453d25]/30 shadow-[0_10px_35px_rgba(72,52,52,0.03)] space-y-6">
                  <h2 className="text-xl font-heading font-black text-[#0d47a1] flex items-center gap-2">
                    <Sparkles className="w-5 h-5 text-[#e91e63]" /> Visa Services
                  </h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  {/* Required Documents */}
                  <section className="bg-white rounded-3xl p-8 border border-[#453d25]/30 shadow-[0_10px_35px_rgba(72,52,52,0.03)] space-y-6 h-full flex flex-col">
                    <h2 className="text-xl font-heading font-black text-[#0d47a1] flex items-center gap-2 mb-2">
                      <FileText className="w-5 h-5 text-[#e91e63]" /> Required Documents
                    </h2>
                    <div className="space-y-4 flex-1">
                      {item?.documents?.length > 0 ? (
                        item.documents.map((doc: string, idx: number) => (
                          <div
                            key={idx}
                            className="flex items-start gap-4 p-4 bg-[#453d25]/10 rounded-2xl border border-[#453d25]/20 hover:border-[#e91e63]/30 transition-colors"
                          >
                            <div className="w-6 h-6 rounded-full bg-[#e91e63] text-white flex items-center justify-center text-xs font-black shrink-0 mt-0.5 shadow-md">
                              {idx + 1}
                            </div>
                            <span className="text-sm font-bold text-[#0d47a1] leading-relaxed">
                              {doc}
                            </span>
                          </div>
                        ))
                  ...
                  <section className="bg-white rounded-3xl p-8 border border-[#453d25]/30 shadow-[0_10px_35px_rgba(72,52,52,0.03)] space-y-6 h-full flex flex-col">
                    <h2 className="text-xl font-heading font-black text-[#0d47a1] flex items-center gap-2 mb-2">
                      <Award className="w-5 h-5 text-[#e91e63]" /> Key Benefits
                    </h2>
                    <div className="space-y-3 flex-1">
                      {item?.features?.length > 0 ? (
                        item.features.map((feature: string, idx: number) => (
                          <div
                            key={idx}
                            className="flex items-center gap-3 text-sm text-[#0d47a1] font-medium p-3 rounded-xl bg-slate-50 border border-slate-100"
                          >
              ...
              <div className="space-y-10">
                ...
                <section className="bg-white rounded-3xl p-8 border border-[#453d25]/30 shadow-[0_10px_35px_rgba(72,52,52,0.03)] space-y-8">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-[#453d25]/20 pb-6">
                    <div>
                      <h2 className="text-2xl font-heading font-black text-[#0d47a1] flex items-center gap-2">
                        <Car className="w-6 h-6 text-[#e91e63]" /> Vehicle Overview
                      </h2>
                    ...
                    <div className="bg-[#F9FAFB] px-4 py-2 rounded-xl border border-[#453d25]/40 flex items-center gap-2">
                      ...
                      <span className="text-xs font-black text-[#0d47a1] tracking-wider uppercase">VIP Standard</span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                      ...
                      >
                        ...
                        <p className="text-sm font-black text-[#0d47a1]">
                          {spec.value}
                        </p>
                      </div>
                    ))}
                ...
                <section className="bg-white rounded-3xl p-8 border border-[#453d25]/30 shadow-[0_10px_35px_rgba(72,52,52,0.03)] space-y-6">
                  <h2 className="text-xl font-heading font-black text-[#0d47a1] flex items-center gap-2">
                    <Sparkles className="w-5 h-5 text-[#e91e63]" /> The Experience
                  </h2>
                  <div className="text-sm text-slate-600 leading-relaxed font-light space-y-4">
                    {item.description ? (
                      item.description.split('\n').map((paragraph: string, idx: number) => (
                ...
                <section className="bg-white rounded-3xl p-8 border border-[#453d25]/30 shadow-[0_10px_35px_rgba(72,52,52,0.03)] space-y-6">
                  <h2 className="text-xl font-heading font-black text-[#0d47a1] flex items-center gap-2 mb-6">
                    <ShieldCheck className="w-5 h-5 text-[#e91e63]" /> Premium Amenities
                  </h2>
          ...
          <aside className="lg:col-span-4 space-y-8">
            <div className="sticky top-28 space-y-8">
              ...
              {relatedArticles.length > 0 && (
                <div className="rounded-3xl border border-[#453d25]/25 p-6 bg-white space-y-5">
                  <h3 className="text-xs font-heading font-black text-[#0d47a1] uppercase tracking-[0.2em] mb-4">
                  ...
                  <div className="space-y-4">
                    {relatedArticles.map((related: any) => (
                      <Link
                        key={related.id}
                        href={`/v/${related.slug}`}
                        className="group flex gap-3.5 items-start rounded-2xl p-3 border border-[#453d25]/20 hover:border-[#e91e63]/40 hover:bg-[#453d25]/10 transition-all duration-300"
                      >
              ...
              <div className="rounded-3xl border border-[#453d25]/30 bg-[#453d25]/10 p-6 space-y-4">
                <h3 className="text-[10px] font-heading font-black text-[#0d47a1] uppercase tracking-[0.2em]">
                  Our Services
                </h3>
                <div className="space-y-2">
                  {[
                    ...
                    <Link
                      key={idx}
                      href={srv.href}
                      className="flex items-center gap-2.5 text-xs font-bold text-[#e91e63] hover:text-[#0d47a1] py-1.5 hover:translate-x-0.5 transition-all duration-200"
                    >
                      <span className="w-6 h-6 rounded-full bg-[#453d25]/40 flex items-center justify-center shrink-0 text-[#e91e63]">
                        {srv.icon}
                      </span>
                      {srv.label}
                    </Link>
