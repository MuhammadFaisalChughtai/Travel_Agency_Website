...
const faqs = [
  {
    ...
    answer:
      "Yes, when you book a flight-inclusive holiday or a flight combined with other travel services through Terrific Travel Ltd, your booking is fully ATOL protected.",
  },
  {
    ...
    <div className="py-16 bg-[#fff3e4]/30 border-t border-[#eed6c4]/20">
      <div className="max-w-4xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center space-y-3 mb-10">
          <span className="inline-block px-3 py-1 rounded-full bg-[#eed6c4]/30 text-[#6b4f4f] text-[10px] font-extrabold uppercase tracking-widest border border-[#eed6c4]/50">
            Flight Support
          </span>
