  ...
  return (
    <>
      <button
        ...
        className="flex-1 h-10 flex items-center justify-center gap-2 rounded-xl bg-white text-[#6b4f4f] border border-[#eed6c4]/80 hover:bg-[#fff3e4] hover:border-[#6b4f4f]/40 font-heading font-black text-[10px] uppercase tracking-widest transition-all duration-300 shadow-sm"
      >
