            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow space-y-4">
                ...
                <div className="border-t border-[#d4af37]/20 pt-4 mt-auto">
                  <Link
                    href={`/blog/${post.slug}`}
                    className="inline-flex items-center gap-1.5 text-[11px] font-extrabold text-[#064e3b] group-hover:text-[#064e3b] transition-colors duration-300 uppercase tracking-widest"
                  >
