            ...
            >
              <div className="relative h-48 sm:h-52 w-full overflow-hidden">
                ...
                <div className="absolute top-4 left-4">
                  <span className="px-3 py-1 rounded-full bg-[#89c4e1]/95 backdrop-blur-md text-white text-[9px] font-black uppercase tracking-wider shadow-sm">
                    {post.category}
                  </span>
                </div>
              </div>
              ...
              <div className="p-6 flex flex-col flex-grow space-y-4">
                <div className="flex items-center gap-4 text-[10px] text-slate-400 font-bold uppercase tracking-wider">
                  <span className="flex items-center gap-1.5">
                    <Calendar className="w-3.5 h-3.5 text-[#89c4e1]/70" />
                    {post.date}
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Clock className="w-3.5 h-3.5 text-[#89c4e1]/70" />
                    {post.readTime}
                  </span>
                </div>

                <h3 className="text-lg font-heading font-black text-[#89c4e1] leading-snug group-hover:text-[#89c4e1] transition-colors duration-300 line-clamp-2">
                  {post.title}
                </h3>
                ...
                <div className="border-t border-[#f5edce]/20 pt-4 mt-auto">
                  <Link
                    href={`/blog/${post.slug}`}
                    className="inline-flex items-center gap-1.5 text-[11px] font-extrabold text-[#89c4e1] group-hover:text-[#89c4e1] transition-colors duration-300 uppercase tracking-widest"
                  >
        ...
        {hasMore && (
          <div className="mt-12 text-center">
            <button
              ...
              className="inline-flex items-center justify-center px-8 py-3.5 rounded-full bg-white border border-[#f5edce] text-[#89c4e1] font-bold text-xs hover:bg-[#fffcf9] hover:border-[#89c4e1]/50 hover:shadow-md transition-all duration-300 uppercase tracking-widest group"
            >
              Load More{" "}
