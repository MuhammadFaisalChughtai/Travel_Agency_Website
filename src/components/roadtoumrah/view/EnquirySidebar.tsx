  ...
  return (
    <>
      ...
      <button
        ...
        className="flex items-center justify-center gap-2 w-full h-12 rounded-2xl bg-[#064e3b] text-white hover:bg-[#d4af37] hover:text-[#064e3b] font-heading font-black text-xs uppercase tracking-[0.15em] transition-all duration-300 cursor-pointer shadow-lg"
      >
      ...
      <a
        ...
        className="flex items-center justify-center gap-2 w-full h-10 rounded-2xl border-2 border-[#064e3b] text-[#064e3b] hover:bg-[#064e3b] hover:text-white font-heading font-bold text-[10px] uppercase tracking-wider transition-all duration-300 cursor-pointer"
      >
