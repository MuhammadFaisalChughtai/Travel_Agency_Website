  ...
  return (
    <>
      ...
      <button
        ...
        className="flex items-center justify-center gap-2 w-full h-12 rounded-2xl border-2 border-[#453d25]/80 text-[#453d25] hover:text-[#F9FAFB] hover:border-[#F9FAFB] hover:bg-[#453d25]/10 font-heading font-black text-xs uppercase tracking-[0.15em] transition-all duration-300 cursor-pointer"
      >
      ...
      <a
        ...
        className="flex items-center justify-center gap-2 w-full h-10 rounded-2xl border border-[#453d25]/30 text-[#453d25]/70 hover:text-[#453d25] hover:border-[#453d25]/60 font-heading font-bold text-[10px] uppercase tracking-wider transition-all duration-300 cursor-pointer"
      >
      ...
      {open && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center p-4" onClick={() => setOpen(false)}>
          ...
          <div
            className="relative z-10 w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden border border-[#453d25]/50"
            onClick={e => e.stopPropagation()}
          >
            {/* Modal Header */}
            <div className="bg-[#e91e63] px-6 py-5 flex items-center justify-between">
              <div>
                <h2 className="text-white font-heading font-black text-base tracking-tight">Quick Enquiry</h2>
                {packageTitle && (
                  <p className="text-[#453d25]/80 text-xs mt-0.5 truncate max-w-[240px]">{packageTitle}</p>
                )}
              </div>
              <button
              ...
              {status === "success" ? (
                <div className="py-8 flex flex-col items-center gap-4 text-center">
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 rounded-xl bg-[#e91e63] text-white font-bold text-xs uppercase tracking-widest hover:bg-[#382626] transition-colors"
                  >
                    Close
                  </button>
                </div>
                ...
                <>
                  ...
                  <div className="grid grid-cols-1 gap-3.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-3 rounded-xl bg-slate-50 text-slate-800 border border-slate-200 text-sm focus:bg-white focus:border-[#e91e63] focus:ring-1 focus:ring-[#e91e63] outline-none transition-all font-medium placeholder-slate-400"
                      />
                    </div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-slate-50 text-slate-800 border border-slate-200 text-sm focus:bg-white focus:border-[#e91e63] focus:ring-1 focus:ring-[#e91e63] outline-none transition-all font-medium placeholder-slate-400 resize-none"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 w-full py-3.5 rounded-xl bg-[#e91e63] hover:bg-[#0d47a1] text-[#F9FAFB] font-heading font-black text-xs uppercase tracking-widest transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed shadow-lg"
                  >
                    {status === "loading" ? (
                      <>
                  ...
                  <p className="text-center text-[10px] text-slate-400">
                    Sent directly to{" "}
                    <span className="text-[#e91e63] font-semibold">inquires@terrifictravel.co.uk</span>
                  </p>
                </>
              )}
            </form>
