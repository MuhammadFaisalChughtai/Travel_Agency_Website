...
export function FlightListCard({
  ...
  return (
    <div className="bg-white rounded-xl overflow-hidden border border-[#d4af37]/40 shadow-sm hover:shadow-md hover:border-[#064e3b]/30 transition-all duration-300 flex flex-col h-full">
      ...
      <div className="bg-[#043427] px-4 py-2.5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          {month && (
            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-[#d4af37]/20 text-[#d4af37] text-[9px] font-black uppercase tracking-wider">
      ...
      <div className="grid grid-cols-12 px-4 py-2 border-b border-slate-100 bg-slate-50/50">
        <div className="col-span-5 text-[9px] md:text-[10px] text-[#064e3b] font-bold uppercase tracking-widest text-left">Route & Airline</div>
        <div className="col-span-4 text-[9px] md:text-[10px] text-[#064e3b] font-bold uppercase tracking-widest text-left">Transit / Connection</div>
        <div className="col-span-3 text-[9px] md:text-[10px] text-[#064e3b] font-bold uppercase tracking-widest text-right truncate">Baggage & Fare</div>
      </div>
      ...
      <div className="p-4 flex-1 flex flex-col justify-center space-y-4">
        ...
        <div className="grid grid-cols-12 items-center gap-2">
          ...
          <div className="col-span-5 flex items-start gap-2">
            <PlaneTakeoff className="w-4 h-4 text-[#064e3b] shrink-0 mt-0.5" />
            <div className="min-w-0">
              <div className="flex items-center gap-1">
                <span className="text-xs font-bold text-[#043427]">{departureCode}</span>
                <ArrowRight className="w-3.5 h-3.5 text-slate-400" />
                <span className="text-xs font-bold text-[#043427]">{destinationCode}</span>
              </div>
        ...
        {isReturn && (
          <div className="grid grid-cols-12 items-center gap-2 pt-3 border-t border-dashed border-slate-100">
            {/* Col 1: Route & Airline */}
            <div className="col-span-5 flex items-start gap-2">
              <PlaneLanding className="w-4 h-4 text-[#064e3b] shrink-0 mt-0.5" />
              <div className="min-w-0">
                <div className="flex items-center gap-1">
                  <span className="text-xs font-bold text-[#043427]">{destinationCode}</span>
                  <ArrowRight className="w-3.5 h-3.5 text-slate-400" />
        ...
        <div className="flex items-center justify-between pt-2 border-t border-slate-100">
          <div className="flex items-center gap-1.5 text-[#064e3b] text-[10px] font-bold uppercase tracking-wider">
            <Briefcase className="w-3.5 h-3.5" />
            <span>Cabin + Checked Baggage Incl.</span>
          </div>
          <div className="text-right flex flex-col items-end">
            <div className="bg-[#064e3b] text-white px-3 py-1 rounded-lg shadow-sm">
      ...
      <div className="p-4 bg-[#fcfaf8] border-t border-slate-100 mt-auto">
        <div className="flex items-center gap-2 mb-3">
          <div className="w-6 h-6 rounded-full bg-[#d4af37]/30 flex items-center justify-center">
            <PhoneCall className="w-3 h-3 text-[#064e3b]" />
          </div>
          <span className="text-[11px] text-slate-500 font-medium mr-auto">We are open 24/7</span>
          <a href="tel:+441215291630" className="text-[11px] md:text-xs font-black text-[#064e3b] hover:text-[#043427] transition-colors">
            +44 1215 291630
          </a>
        </div>
        ...
        <div className="flex gap-2">
          ...
          <Link
            href={`/v/${id}`}
            className="flex-1 h-10 flex items-center justify-center gap-1.5 rounded-xl bg-[#064e3b] text-white font-heading font-black text-[10px] uppercase tracking-widest transition-all duration-300 shadow-sm hover:bg-[#483434] hover:shadow-md"
          >
            View Details
