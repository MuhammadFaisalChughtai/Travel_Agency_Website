            ...
            >
              <div className="relative h-56 w-full overflow-hidden">
                ...
                <div className="absolute top-4 left-4 z-10">
                  <span className="px-3 py-1.5 rounded-full bg-white/90 backdrop-blur-md text-[#064e3b] text-[9px] font-black uppercase tracking-widest shadow-sm">
                    {post.category}
                  </span>
                </div>
              </div>
              ...
              <div className="p-8 flex flex-col flex-grow space-y-4">
                ...
                <h3 className="text-xl font-heading font-black text-slate-900 leading-snug group-hover:text-[#064e3b] transition-colors duration-300">
                  {post.title}
                </h3>
                ...
                <div className="border-t border-slate-100 pt-5">
                  <Link
                    href={`/blog/${post.slug}`}
                    className="inline-flex items-center gap-2 text-xs font-black text-[#064e3b] group-hover:text-slate-900 transition-colors duration-300 uppercase tracking-widest"
                  >
        ...
        {hasMore && (
          <div className="mt-16 text-center">
            <button
              ...
              className="inline-flex items-center justify-center whitespace-nowrap focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 px-4 py-2 flex-1 h-11 text-xs rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 font-extrabold tracking-widest uppercase border bg-[#064e3b] hover:bg-[#064e3b] text-[#F9FAFB] border-[#d4af37]/30"
            >
