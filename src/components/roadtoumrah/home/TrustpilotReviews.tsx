...
export function TrustpilotReviews() {
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-[#F9F6F0]/30 to-white border-t border-[#D4AF37]/45">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <div className="h-[2px] w-12 bg-[#B8860B]/30 my-4 rounded-full"></div>
              ...
              {data?.reviews.slice(0, 9).map((review) => (
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[9px] font-black uppercase tracking-widest text-[#B8860B] bg-[#D4AF37]/20 px-2.5 py-1 rounded-md border border-[#D4AF37]/10">
                      {review.tag}
                    </span>
                  </div>

                  {/* Title & Text */}
                  <h3 className="font-heading font-black text-[#1A472A] text-base mb-2.5 line-clamp-1">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-slate-100 mt-auto">
                  <div>
                    <p className="text-xs font-black text-[#1A472A]">
                      {review.author}
                    </p>
