...
export function TrustpilotReviews() {
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-[#F9FAFB]/30 to-white border-t border-[#DFDE7D]/45">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <div className="h-[2px] w-12 bg-[#009F75]/30 my-4 rounded-full"></div>
          ...
          <a
            ...
            className="group flex flex-wrap items-center justify-center gap-4 mt-2 bg-white px-5 py-3 rounded-2xl border border-[#DFDE7D]/50 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-0.5"
          >
        ...
        {loading ? (
          ...
          <div className="flex gap-6 overflow-hidden pb-6">
            {[...Array(3)].map((_, i) => (
              <div
                key={i}
                className="w-full sm:w-[350px] shrink-0 bg-white rounded-3xl p-7 border border-[#DFDE7D]/45 shadow-[0_10px_30px_rgba(72,52,52,0.02)] animate-pulse"
              >
          ...
          <div className="relative group -mx-2 px-2">
            ...
            >
              {data?.reviews.slice(0, 9).map((review) => (
                <div
                  key={review.id}
                  className="w-[85vw] sm:w-[360px] shrink-0 snap-center bg-white rounded-3xl p-7 border border-[#DFDE7D]/45 shadow-[0_10px_30px_rgba(72,52,52,0.02)] hover:shadow-[0_15px_40px_rgba(72,52,52,0.06)] hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between"
                >
                <div>
                  {/* Header: Rating & Tag */}
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[9px] font-black uppercase tracking-widest text-[#009F75] bg-[#DFDE7D]/20 px-2.5 py-1 rounded-md border border-[#DFDE7D]/10">
                      {review.tag}
                    </span>
                  </div>

                  {/* Title & Text */}
                  <h3 className="font-heading font-black text-[#454E63] text-base mb-2.5 line-clamp-1">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-slate-100 mt-auto">
                  <div>
                    <p className="text-xs font-black text-[#454E63]">
                      {review.author}
                    </p>
