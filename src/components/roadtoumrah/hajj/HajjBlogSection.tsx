        ...
        {hasMore && (
          <div className="mt-12 text-center">
            <Button
              ...
              className="rounded-full gap-2 px-8 py-6 bg-[#064e3b] hover:bg-[#483434] text-emerald-50 border border-[#d4af37]/40/45 font-extrabold uppercase text-xs tracking-wider shadow-md hover:shadow-lg transition-all duration-300"
            >
