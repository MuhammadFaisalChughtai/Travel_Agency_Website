...
Passengers: ${formData.travelers}
  ...
  const fieldClass =
    "w-full pl-10 pr-4 py-3 rounded-xl bg-slate-50 text-slate-800 border border-slate-200/80 text-xs md:text-sm focus:bg-white focus:border-[#009F75] focus:ring-1 focus:ring-[#009F75] transition-all duration-300 outline-none font-medium placeholder:text-slate-400";
  const selectClass =
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            {/* Hotel Input */}
            <div className="relative">
              <Building className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-[#009F75] pointer-events-none" />
              <select
                name="category"
            ...
            {/* Duration Input */}
            <div className="relative">
              <Clock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-[#009F75] pointer-events-none" />
              <select
                name="duration"
