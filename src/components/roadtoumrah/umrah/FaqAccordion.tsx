    ...
    <div className="py-12 bg-background">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <span className="inline-block px-3 py-0.5 rounded-full bg-[#F9F6F0] border border-[#D4AF37]/30 text-[#B8860B] text-[10px] font-bold tracking-widest uppercase mb-3">
            Frequently Asked Questions
          </span>
          <h2 className="text-2xl md:text-3xl font-heading font-black text-[#B8860B]">
            ...
            return (
              <div
                ...
                className={`border rounded-xl transition-all duration-300 overflow-hidden ${
                  isOpen
                    ? "border-[#B8860B]/40 shadow-sm bg-card"
                    : "border-[#D4AF37]/30 bg-[#F9F6F0]/40 hover:border-[#B8860B]/35"
                }`}
              >
                <button
                ...
                >
                  <span
                    className={`font-semibold pr-8 text-sm md:text-base ${isOpen ? "text-[#B8860B] font-black" : "text-[#382626] font-medium"}`}
                  >
                    {faq.question}
                  </span>
                  <div
        ...
        <div className="mt-10 text-center">
          ...
          <Link href="/contact">
            <Button className="rounded-full gap-2 px-6 py-5 bg-[#B8860B] hover:bg-[#1A472A] text-[#F9F6F0] font-bold text-xs uppercase tracking-widest shadow-md">
