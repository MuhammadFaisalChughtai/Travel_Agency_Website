...
export function UmrahInfoSection() {
  ...
  return (
    <div className="py-12 bg-[#F9FAFB]/40 border-t border-[#d4af37]/20">
            ...
            {[
              ...
              <button
                ...
                className={`px-5 py-2 text-xs md:text-sm font-bold rounded-xl transition-all duration-300 ${
                  activeTab === tab.id
                    ? "bg-[#064e3b] text-[#F9FAFB] shadow-md scale-[1.02]"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center animate-fade-in">
              <div className="lg:col-span-7 space-y-4">
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  <span className="px-3 py-1 bg-[#F9FAFB] border border-[#d4af37]/30 rounded-lg text-[10px] text-[#064e3b] font-bold uppercase tracking-wider">
                    ★ ATOL Protected
                  </span>
                  <span className="px-3 py-1 bg-[#F9FAFB] border border-[#d4af37]/30 rounded-lg text-[10px] text-[#064e3b] font-bold uppercase tracking-wider">
                    ★ IATA Certified
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {[
                  ...
                  <div
                    key={i}
                    className="p-3.5 bg-[#F9FAFB]/40 rounded-2xl border border-[#d4af37]/25 hover:border-[#d4af37] transition-all duration-300 flex items-start gap-3 group"
                  >
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={i}
                    className="p-4 bg-[#F9FAFB]/40 rounded-2xl border border-[#d4af37]/25 flex items-start gap-3 hover:shadow-sm transition-shadow duration-300"
                  >
