...
export function HolidayInfoSection() {
  ...
  return (
    <div className="py-12 bg-emerald-50/40 border-t border-[#d4af37]/20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center animate-fade-in">
              <div className="lg:col-span-7 space-y-4">
                ...
                <p className="text-slate-700 text-xs md:text-sm leading-relaxed font-light">
                  From the pristine beaches of the Maldives to the bustling streets of Tokyo, Road To Umrah brings you handpicked holiday experiences. Our packages are designed to give you the perfect balance of relaxation and adventure, all tailored strictly to your preferences.
                </p>
                <p className="text-slate-700 text-xs md:text-sm leading-relaxed font-light">
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  <span className="px-3 py-1 bg-emerald-50 border border-[#d4af37]/30 rounded-lg text-[10px] text-[#064e3b] font-bold uppercase tracking-wider">
                    ★ ATOL Protected
                  </span>
                  <span className="px-3 py-1 bg-emerald-50 border border-[#d4af37]/30 rounded-lg text-[10px] text-[#064e3b] font-bold uppercase tracking-wider">
                    ★ Premium Resorts
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {[
                  ...
                  <div
                    key={i}
                    className="p-3.5 bg-emerald-50/40 rounded-2xl border border-[#d4af37]/25 hover:border-[#d4af37] transition-all duration-300 flex items-start gap-3 group"
                  >
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={i}
                    className="p-4 bg-emerald-50/40 rounded-2xl border border-[#d4af37]/25 flex items-start gap-3 hover:shadow-sm transition-shadow duration-300"
                  >
