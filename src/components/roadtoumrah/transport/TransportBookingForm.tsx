...
export function TransportBookingForm({
  ...
  const fieldClass =
    "w-full pl-10 pr-4 py-3 rounded-xl bg-slate-50 text-slate-800 border border-slate-200/80 text-xs md:text-sm focus:bg-white focus:border-[#89c4e1] focus:ring-1 focus:ring-[#89c4e1] transition-all duration-300 outline-none font-medium placeholder-slate-400";
  const selectClass =
      ...
      >
        {!isHome && !isModal && (
          <div className="text-center mb-6">
            ...
            <div className="h-[2px] w-12 bg-[#89c4e1]/30 mx-auto mt-2 rounded-full" />
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="relative">
              <Car className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-[#89c4e1] pointer-events-none" />
              <select
                name="serviceType"
            ...
            {/* Pickup Location */}
            <div className="relative">
              <MapPin className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-[#89c4e1] pointer-events-none" />
              <input
                type="text"
                name="pickup"
