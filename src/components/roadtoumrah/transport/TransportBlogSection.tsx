            ...
            >
              <div className="relative h-48 sm:h-52 w-full overflow-hidden">
                ...
                <div className="absolute top-4 left-4">
                  <span className="px-3 py-1 rounded-full bg-[#c63c51]/95 backdrop-blur-md text-white text-[9px] font-black uppercase tracking-wider shadow-sm">
                    {post.category}
                  </span>
                </div>
              </div>
              ...
              <div className="p-6 flex flex-col flex-grow space-y-4">
                <div className="flex items-center gap-4 text-[10px] text-slate-400 font-bold uppercase tracking-wider">
                  <span className="flex items-center gap-1.5">
                    <Calendar className="w-3.5 h-3.5 text-[#c63c51]/70" />
                    {post.date}
                  </span>
                  <span className="flex items-center gap-1.5">
                    <Clock className="w-3.5 h-3.5 text-[#c63c51]/70" />
                    {post.readTime}
                  </span>
                </div>

                <h3 className="text-lg font-heading font-black text-[#522258] leading-snug group-hover:text-[#c63c51] transition-colors duration-300 line-clamp-2">
                  {post.title}
                </h3>
                ...
                <div className="border-t border-[#8c3061]/20 pt-4 mt-auto">
                  <Link 
                    href={`/blog/${post.slug}`} 
                    className="inline-flex items-center gap-1.5 text-[11px] font-extrabold text-[#c63c51] group-hover:text-[#522258] transition-colors duration-300 uppercase tracking-widest"
                  >
        ...
        {hasMore && (
          <div className="mt-12 text-center">
            <button 
              ...
              className="inline-flex items-center justify-center px-8 py-3.5 rounded-full bg-white border border-[#8c3061] text-[#c63c51] font-bold text-xs hover:bg-[#fffcf9] hover:border-[#c63c51]/50 hover:shadow-md transition-all duration-300 uppercase tracking-widest group"
            >
