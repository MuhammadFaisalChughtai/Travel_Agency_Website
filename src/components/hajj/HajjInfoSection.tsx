...
export function HajjInfoSection() {
  ...
  return (
    <div className="py-12 bg-[#fff3e4]/40 border-t border-[#eed6c4]/40/20">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-center mb-8">
          <div className="inline-flex bg-[#eed6c4]/10 p-1.5 rounded-2xl border border-[#eed6c4]/40/20 shadow-inner">
            {[
        ...
        <div className="bg-card rounded-3xl p-5 md:p-8 shadow-[0_10px_40px_rgba(56,38,38,0.03)] border border-[#eed6c4]/40/20 transition-all duration-500 min-h-[400px]">
          {/* OVERVIEW TAB */}
          {activeTab === "overview" && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center animate-fade-in">
              <div className="lg:col-span-7 space-y-4">
                ...
                <p className="text-slate-700 text-xs md:text-sm leading-relaxed font-light">
                  Hajj is the fifth pillar of Islam, an profound spiritual journey that every able Muslim must undertake. At Terrific Travel Ltd, we recognize the immense significance of this obligation and have dedicated our expertise to ensuring your pilgrimage is seamless, comfortable, and spiritually enriching.
                </p>
                <p className="text-slate-700 text-xs md:text-sm leading-relaxed font-light">
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  <span className="px-3 py-1 bg-[#fff3e4] border border-[#eed6c4]/40/30 rounded-lg text-[10px] text-[#6b4f4f] font-bold uppercase tracking-wider">
                    ★ Ministry Approved
                  </span>
                  <span className="px-3 py-1 bg-[#fff3e4] border border-[#eed6c4]/40/30 rounded-lg text-[10px] text-[#6b4f4f] font-bold uppercase tracking-wider">
                    ★ VIP Mina Tents
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {[
                  ...
                  <div
                    key={i}
                    className="p-3.5 bg-[#fff3e4]/40 rounded-2xl border border-[#eed6c4]/40/25 hover:border-[#eed6c4]/40 transition-all duration-300 flex items-start gap-3 group"
                  >
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={i}
                    className="p-4 bg-[#fff3e4]/40 rounded-2xl border border-[#eed6c4]/40/25 flex items-start gap-3 hover:shadow-sm transition-shadow duration-300"
                  >
