...
import { MapPin, Phone, Mail, ChevronRight, Facebook, Instagram, PhoneCall, Compass } from "lucide-react";
import Image from "next/image";
import { TrustpilotWidget } from "./TrustpilotWidget";

const logoUrl = "https://terrifictravel.co.uk/wp-content/uploads/2025/07/TT-4.svg";
  ...
  return (
    <footer className="relative bg-[#eed6c4] text-[#483434] border-t border-[#6b4f4f]/25 overflow-hidden">
      ...
      <div className="absolute bottom-12 right-6 opacity-5 pointer-events-none hidden lg:block">
        <svg width="120" height="120" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#6b4f4f]">
          <path d="M10 80C30 50 60 90 90 60" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeDasharray="4 4" />
          <path d="M85 55L90 60L83 65" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        </svg>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 pb-12">
          ...
          <div className="lg:col-span-3 space-y-6 flex flex-col">
            <Link href="/" className="flex items-center gap-2 self-start">
              ...
              <Image src={logoUrl} alt="Terrific Travel" width={180} height={70} className="w-auto h-16 sm:h-20" />
            </Link>
            ...
            <p className="text-xs leading-relaxed text-[#483434]/95 font-medium max-w-xs">
              Terrific Travel – Committed to making your journeys meaningful, safe, and unforgettable.
            </p>
            <TrustpilotWidget />
          </div>
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="space-y-1.5">
              <h3 className="text-xs md:text-sm font-black tracking-wider uppercase text-[#6b4f4f] font-heading">Useful Links</h3>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={i}>
                  <Link href={link.href} className="text-xs font-semibold hover:text-[#6b4f4f] flex items-center gap-1 transition-colors duration-200 group">
          ...
          <div className="lg:col-span-2 md:col-span-1 lg:col-span-2.5 space-y-4">
            <div className="space-y-1.5">
              <h3 className="text-xs md:text-sm font-black tracking-wider uppercase text-[#6b4f4f] font-heading">Informative Links</h3>
              <div className="flex items-center gap-1.5">
                <span className="h-[1.5px] w-8 bg-[#6b4f4f]"></span>
                <span className="w-1.5 h-1.5 rounded-full bg-[#6b4f4f]"></span>
                <span className="h-[1.5px] w-4 bg-[#6b4f4f]/30"></span>
            ...
            <ul className="space-y-3">
              {[
                ...
                { label: "How To Book Kiswah Factory Appointment?", href: "/umrah" },
                { label: "Places To Visit in Makkah and Madinah", href: "/umrah" }
              ].map((link, i) => (
                <li key={i}>
                  <Link href={link.href} className="text-xs font-semibold hover:text-[#6b4f4f] flex items-start gap-1 transition-colors duration-200 group leading-snug">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="space-y-1.5">
              <h3 className="text-xs md:text-sm font-black tracking-wider uppercase text-[#6b4f4f] font-heading">Umrah & Hajj Packages</h3>
              <div className="flex items-center gap-1.5">
                <span className="h-[1.5px] w-8 bg-[#6b4f4f]"></span>
                <span className="w-1.5 h-1.5 rounded-full bg-[#6b4f4f]"></span>
                <span className="h-[1.5px] w-4 bg-[#6b4f4f]/30"></span>
          ...
          <div className="lg:col-span-2.5 space-y-4">
            <div className="space-y-1.5">
              <h3 className="text-xs md:text-sm font-black tracking-wider uppercase text-[#6b4f4f] font-heading">Contact Us</h3>
              <div className="flex items-center gap-1.5">
                <span className="h-[1.5px] w-8 bg-[#6b4f4f]"></span>
                <span className="w-1.5 h-1.5 rounded-full bg-[#6b4f4f]"></span>
                <span className="h-[1.5px] w-4 bg-[#6b4f4f]/30"></span>
            ...
            <ul className="space-y-3.5">
              <li className="flex items-start gap-2.5">
                ...
                <span className="text-xs font-semibold leading-relaxed">Office 1, 11 Walford Road, Birmingham, B11 1NP</span>
              </li>
              <li className="flex items-center gap-2.5">
                <Mail className="w-4 h-4 text-[#6b4f4f] shrink-0" />
                <a href="mailto:inquires@terrifictravel.co.uk" className="text-xs font-semibold hover:underline">inquires@terrifictravel.co.uk</a>
              </li>
              <li className="flex items-center gap-2.5">
                <Phone className="w-4 h-4 text-[#6b4f4f] shrink-0" />
                <a href="tel:+441215291630" className="text-xs font-semibold hover:underline">+441215291630</a>
              </li>
              <li className="flex items-center gap-2 pt-2 border-t border-[#483434]/15">
                ...
                <span className="text-[11px] font-black tracking-wider text-[#483434]">91206076</span>
              </li>
            </ul>
          </div>
      ...
      <div className="bg-[#483434] text-[#fff3e4] py-4 text-center border-t border-[#6b4f4f]/30">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs font-semibold">
          <p className="text-[#eed6c4]/80">
            Copyright &copy; {new Date().getFullYear()} Terrific Travel | All Rights Reserved By Terrific Travel
          </p>
        </div>
      </div>
    </footer>
