  ...
  return (
    <div className="py-6 relative group max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative">
        <button
          onClick={() => scroll("left")}
          className="absolute -left-4 top-1/2 -translate-y-1/2 z-10 w-9 h-9 rounded-full bg-white text-[#6b4f4f] border border-[#eed6c4]/50 shadow-md flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-[#6b4f4f] hover:text-[#fff3e4] hover:border-[#6b4f4f] disabled:opacity-0 focus:opacity-100"
          aria-label="Previous"
        >
        ...
        <button
          ...
          className="absolute -right-4 top-1/2 -translate-y-1/2 z-10 w-9 h-9 rounded-full bg-white text-[#6b4f4f] border border-[#eed6c4]/50 shadow-md flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-[#6b4f4f] hover:text-[#fff3e4] hover:border-[#6b4f4f] disabled:opacity-0 focus:opacity-100"
          aria-label="Next"
        >
