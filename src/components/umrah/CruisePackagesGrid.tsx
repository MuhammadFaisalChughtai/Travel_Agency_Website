      ...
      {visibleCount < packages.length && (
        <div className="flex justify-center mt-12">
          <button
            ...
            className="px-8 py-3.5 bg-[#6b4f4f] hover:bg-[#483434] text-[#fff3e4] text-xs font-extrabold uppercase tracking-widest transition-all duration-300 rounded-2xl shadow-md hover:shadow-lg border border-[#eed6c4]/30 outline-none"
          >
            Load More Packages
          </button>
        </div>
