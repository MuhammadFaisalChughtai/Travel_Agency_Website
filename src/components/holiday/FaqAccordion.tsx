...
const faqs = [
  {
    ...
    answer:
      "Yes, absolutely. Every flight-inclusive holiday package booked with Terrific Travel Ltd is 100% ATOL protected. You will receive an ATOL Certificate upon booking, ensuring your financial security.",
  },
  {
