...
export function TrustpilotReviews() {
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-[#fff3e4]/30 to-white border-t border-[#eed6c4]/45">
        ...
        {loading ? (
          ...
          <div className="flex gap-6 overflow-hidden pb-6">
            {[...Array(3)].map((_, i) => (
              <div
                key={i}
                className="w-full sm:w-[350px] shrink-0 bg-white rounded-3xl p-7 border border-[#eed6c4]/45 shadow-[0_10px_30px_rgba(72,52,52,0.02)] animate-pulse"
              >
              ...
              {data?.reviews.slice(0, 9).map((review) => (
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[9px] font-black uppercase tracking-widest text-[#6b4f4f] bg-[#eed6c4]/20 px-2.5 py-1 rounded-md border border-[#eed6c4]/10">
                      {review.tag}
                    </span>
                  </div>

                  {/* Title & Text */}
                  <h3 className="font-heading font-black text-[#483434] text-base mb-2.5 line-clamp-1">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-slate-100 mt-auto">
                  <div>
                    <p className="text-xs font-black text-[#483434]">
                      {review.author}
                    </p>
