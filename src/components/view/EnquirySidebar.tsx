  ...
  return (
    <>
      ...
      <button
        ...
        className="flex items-center justify-center gap-2 w-full h-12 rounded-2xl border-2 border-[#d4af37]/80 text-[#d4af37] hover:text-emerald-50 hover:border-emerald-50 hover:bg-[#d4af37]/10 font-heading font-black text-xs uppercase tracking-[0.15em] transition-all duration-300 cursor-pointer"
      >
