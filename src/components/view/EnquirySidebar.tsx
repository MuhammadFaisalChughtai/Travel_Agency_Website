  ...
  return (
    <>
      ...
      <button
        ...
        className="flex items-center justify-center gap-2 w-full h-12 rounded-2xl border-2 border-[#eed6c4]/80 text-[#eed6c4] hover:text-[#fff3e4] hover:border-[#fff3e4] hover:bg-[#eed6c4]/10 font-heading font-black text-xs uppercase tracking-[0.15em] transition-all duration-300 cursor-pointer"
      >
          ...
          >
            ...
            <div className="bg-gradient-to-r from-[#382626] to-[#6b4f4f] px-6 py-5 flex items-center justify-between">
              <div>
                ...
                {packageTitle && (
                  <p className="text-[#eed6c4]/80 text-xs mt-0.5 truncate max-w-[240px]">{packageTitle}</p>
                )}
              </div>
              <button
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              {status === "success" ? (
                <div className="py-8 flex flex-col items-center gap-4 text-center">
                  ...
                  <div>
                    <h3 className="font-heading font-black text-[#6b4f4f] text-lg">Enquiry Sent!</h3>
                    <p className="text-[#f5f0eb]0 text-sm mt-1">Our team will contact you within 24 hours.</p>
                  </div>
                  <button
                    type="button"
                ...
                <>
                  ...
                  <p className="text-center text-[10px] text-slate-400">
                    Sent directly to{" "}
                    <span className="text-[#6b4f4f] font-semibold">inquires@terrifictravel.co.uk</span>
                  </p>
                </>
              )}
            </form>
