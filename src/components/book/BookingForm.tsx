...
function BookingContent() {
  ...
  const isHajj =
    !isFlight && !isVisa && !isTransport && id.toLowerCase().includes("hajj");
  ...
  const fieldClass =
    "w-full pl-10 pr-4 py-3.5 rounded-xl bg-slate-50 text-slate-800 border border-slate-200 text-sm focus:bg-white focus:border-[#6b4f4f] focus:ring-2 focus:ring-[#6b4f4f]/20 transition-all duration-300 outline-none font-medium placeholder-slate-400";
  const selectClass =
    "w-full pl-10 pr-8 py-3.5 rounded-xl bg-slate-50 text-slate-800 border border-slate-200 text-sm focus:bg-white focus:border-[#6b4f4f] focus:ring-2 focus:ring-[#6b4f4f]/20 transition-all duration-300 outline-none appearance-none cursor-pointer font-medium";
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 mt-5">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 text-sm max-w-md mx-auto">
            {isFlight
              ...
              : isVisa || isTransport
                ? "Fill in your details below and our team will get back to you with a free quote."
        ...
        <div className="bg-white/95 backdrop-blur-md rounded-3xl shadow-[0_30px_60px_rgba(56,38,38,0.10)] border border-[#eed6c4]/60 p-6 md:p-10">
          <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
              {isFlight ? (
                ...
                <>
                  ...
                  <div className="relative">
                    <Calendar
                      className={`absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 pointer-events-none ${formData.tripType === "One Way" ? "text-slate-300" : "text-[#6b4f4f]"}`}
                    />
                    <input
                      type="date"
                      name="returnDate"
                ...
                <>
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <option value="Non-Shifting VIP">
                        Non-Shifting (VIP)
                      </option>
                      <option value="Shifting Standard">
                        Shifting (Standard)
                      </option>
                    </select>
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-slate-400 text-xs">
              ...
              ) : !isFlight && !isVisa && !isTransport && !isHajj ? (
                ...
                // Visa and Transport Specific Fields
                <>
                  <div className="relative">
                    <Calendar className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-[#6b4f4f] pointer-events-none" />
                    <input
            ...
            <div
              className={`grid grid-cols-1 sm:grid-cols-2 ${isFlight ? "lg:grid-cols-5" : isVisa || isTransport ? "lg:grid-cols-4" : "lg:grid-cols-4"} gap-4 mb-6`}
            >
              {/* Travelers */}
              <div className="relative">
      ...
      fallback={
        <div className="min-h-screen bg-[#fff3e4] flex items-center justify-center">
          <div className="flex flex-col items-center gap-4 text-[#6b4f4f]">
            ...
            <p className="font-heading font-black text-sm uppercase tracking-widest">
              Loading Booking...
            </p>
          </div>
        </div>
