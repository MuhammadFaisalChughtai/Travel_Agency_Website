    ...
    <div ref={formRef}>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 max-w-4xl">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">Leave blank to auto-generate from Vehicle Type and Service Type.</p>
        </div>
        ...
        <div className="flex items-center gap-4 pt-2">
          ...
          {initialData?.id && (
            <a href="/admin/transport" className="text-sm text-slate-500 hover:text-slate-700 font-semibold underline">
              Cancel
            </a>
          )}
        </div>
